...
#ifndef BUDGET_PLANNER_SWIFT_H
#define BUDGET_PLANNER_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Budget_Planner",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14Budget_Planner19SubscriptionManager")
@interface SubscriptionManager : NSObject <SKPaymentTransactionObserver, SKProductsRequestDelegate>
